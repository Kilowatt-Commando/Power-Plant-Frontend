...
export function AnimateImageGroup({ id, title, step, image, text, imageDimensions }: ImageGroupProps) {
  return (
    <div id={id} className='opacity-0 flex flex-col justify-between items-center gap-2 rounded-xl bg-gray-200 dark:bg-neutral-700/80 shadow-md shadow-gray-400 dark:shadow-neutral-900 p-4 relative'>
